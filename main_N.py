...
if __name__ == "__main__":
    ...
    file_name = f"{args.policy}_{args.env}_{args.alpha}_{args.N_step}_{args.la}_{args.batch_size}_{args.seed}"
    print("---------------------------------------")
    ...
    if args.policy == "TD3_N_1":
        kwargs["policy_noise"] = args.policy_noise * max_action
        kwargs["noise_clip"] = args.noise_clip * max_action
        kwargs["policy_freq"] = args.policy_freq

        policy = TD3_N_1.TD3_N_1(**kwargs)
        ...
        if done:
            ...
            for i in range(len_buffer):
                ...
                for j in range(i, min(i + args.N_step, len_buffer)):
                    ...
                    gamma *= args.la
                ds_factor = (1 - args.la) / (args.la * (1 - gamma / args.la))
